...
<div class="row">
	...
	<ol class="breadcrumb">
	  ...
	  <li class="active"><span class="fa fa-tasks"></span>Data Kriteria</li>
	</ol>
<form method="post">
	<div class="row">
		<div class="col-md-6 text-left">
			<strong style="font-size:18pt;"><span class="fa fa-tasks"></span> Data Kriteria</strong>
		</div>
		<div class="col-md-6 text-right">
        <button type="button" onclick="location.href='input-data-kriteria.php'" class="btn btn-primary btn-sm"><span class="fa fa-clone"></span> Tambah Data</button>
...
?>
            <tr>
                ...
                <td style="vertical-align:middle;"><?php echo $row['bobot_kriteria']/100; ?> </td>
                <td style="vertical-align:middle;"><?php echo $row['bobot_kriteria']; ?>% </td>
                <td style="text-align:center;vertical-align:middle;">
					<a href="input-data-kriteria.php?id_kriteria=<?php echo $row['id_kriteria'] ?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
